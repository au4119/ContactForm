...
<p><input type="reset" value="Clear Form" />&nbsp; &nbsp;<input type="submit" name="Submit" value="Sed Form" /></p>
</form>
<?php
}
$ShowForm = TRUE;
...
if ($ShowForm == TRUE) {
	if $ErrorCount>0) // if there were errors
		echo "<p>Please re-enter the form information below."
	displayForm($Sender, $Email, $Subject, $Message);
}
else {
	$SenderAddress = "$Sender <$Email>";
	$Headers = "From: $SenderAddress\nCC: SenderAddress\n";
	$result = mail("john.doe123@hotmail.cp.uk", $Subject, $Message, $Headers);
	if ($result)
